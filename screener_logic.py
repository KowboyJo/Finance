...
def check_earnings_conflict(ticker_symbol, exp_date):
    """Safely checks if an upcoming earnings date occurs before expiration."""
    try:
...
def analyze_puts(
    ...
    """Analyzes option chains with risk & liquidity filters."""
    # 1. Earnings Check
    ...
    try:
        ...
        # 2. Open Interest Check (Safe handling for NaNs)
